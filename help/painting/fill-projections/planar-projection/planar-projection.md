...
description: "Use planar projection in Substance 3D Painter to project textures from a flat plane for straightforward texture application."
...
The Planar projection of the fill is a 3D projection that projects an image in a direction as a plane. It can be used to project signs, decals and other patterns on the surface or through the 3D model.
...
| **UV Wrap** | Control how the texture repeats within the projection. Possible values are:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>None</strong>: the texture doesn't repeat. Anything outside the texture is black/transparent.</li><li data-preserve-html="true"><strong>Repeat horizontally</strong>: the texture only repeats horizontally.</li><li data-preserve-html="true"><strong>Repeat vertically</strong>: the texture only repeats vertically.</li><li data-preserve-html="true"><strong>Repeat</strong> (default): the texture repeats on both axes.</li></ul> <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r2-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="planar-repeat.jpg" width="500px"/></div> |
| **Shape crop** | Define if the projected texture should be visible outside of the projection area. Possible values are:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>Project cropped to shape</strong>: the projection is confined within the projection area.</li><li data-preserve-html="true"><strong>Projection extends outside shape</strong> (default): the projection continues beyond the projection area.</li></ul> <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r3-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="shape-crop-toggle.gif" width="600px"/></div> |
| **Depth culling** | If enabled, the projection will fade/cut along its projection axis instead of being infinite.  <ul class="steps" data-preserve-html="true"> <li class="step" data-preserve-html="true">    <strong>Enabled</strong>:<br/>       <img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r4-column-c1_procedure_proc_par_proc_step_step_par_image" src="depth-culling-on.jpg" width="300px"/>    <!-- Modal -->   </li> <li class="step" data-preserve-html="true">    <strong>Disabled</strong>:<br/>       <img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r4-column-c1_procedure_proc_par_proc_step1_step_par_image" src="depth-culling-off.jpg" width="300px"/>    <!-- Modal -->   </li> </ul>  There is one parameter available:<ul data-preserve-html="true"><li data-preserve-html="true">The <strong>hardness</strong> setting controls how hard or soft the depth culling is along the projection axis.</li></ul> <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r4-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="depth-culling-hardness.gif"/></div> |
| **Backface culling** | If enabled, the projection will not appear on the 3D model's faces that are looking away from the projection axis.There are two parameters available:<ul data-preserve-html="true"><li data-preserve-html="true"><strong>Angle</strong>: define the minimum angle which determines when faces that are looking away should be ignored.</li><li data-preserve-html="true"><strong>Hardness</strong>: define how hard or soft the transition should be.</li></ul> <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r5-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="backface-culling.gif"/></div> |

>[!NOTE]
>
> Adjusting the transformation scale allows to control the depth of projection as well:
> 
