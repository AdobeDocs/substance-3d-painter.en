...
Fonts can be imported manually or put into an existing Painter's library like any regular resources. To do so see the [import documentation](../content/importing-assets/import-drag-and-drop.md).
