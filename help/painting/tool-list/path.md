...
Some properties are specific to a path as a whole. This is the case for options found in the <b>Properties </b>window. Just like with a regular stroke (see the [Paint tool documentation](paint-brush.md)), it is possible to define the following properties for a path:
