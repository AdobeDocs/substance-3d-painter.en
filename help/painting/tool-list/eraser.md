...
The Eraser share common parameters and behaviors with the Paint tool. To know more about the brush, alpha and stencil controls take a look at the [Paint tool page](paint-brush.md).
