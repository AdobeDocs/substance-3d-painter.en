...
>[!NOTE]
>
> Some parameters may be controlled by Pen Pressure when using a graphic tablet. This information can also be saved in [Presets](../../../painting/presets/presets.md) .   
