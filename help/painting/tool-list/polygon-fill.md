...
Polygon fill tool functions on [Paint Layers,](../../interface/layer-stack/layer-stack.md) but is limited to basecolor only and not intended for this purpose. [Use it for masks only](../../interface/layer-stack/masking-and-effects.md).
