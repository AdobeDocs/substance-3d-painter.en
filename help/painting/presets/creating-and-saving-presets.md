...
Use the [Properties window](../../interface/properties.md) to tweak brush parameters, then save the brush configuration as a preset for quick re-use in the future.

>[!NOTE]
>
> With the [Path tool](../tool-list/path.md) equipped, a Presets section is available in the [Properties panel](../../interface/properties.md) where you can quickly access Path related presets. You can also add path presets to your favorites. Learn more about managing your favorite [path presets here](../tool-list/path.md).
