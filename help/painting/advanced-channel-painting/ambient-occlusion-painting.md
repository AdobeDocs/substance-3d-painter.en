...
To paint custom occlusion details, an Ambient Occlusion channel is required. It can be added via the [Texture Set settings](../../interface/texture-set/texture-set-settings.md):
...
To know more about them and how to change them per channel, see: [Blending modes](../../interface/layer-stack/blending-modes.md).
