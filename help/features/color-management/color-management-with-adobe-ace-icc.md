...
The project settings can be set when creating a new project via the [new project](../../getting-started/project-creation.md) window or by using the [project configuration](../../interface/project-configuration.md) window.
...
For more details see the [Environment variables](../../pipeline-and-integration/configuration/environment-variables.md) page.
