...
> However individual resources can be updated with the [Resources Updater](plugins/resources-updater.md) .
...
To find the  **shelf location**  , see : [Adding content on the hard drive](../content/importing-assets/adding-content-on-the-hard-drive.md) .
