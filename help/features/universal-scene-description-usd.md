...
* [Create a project](../getting-started/project-creation.md), making use of USD specific features, such as choice of scope and variants, subdivison levels and animation frames.
* [Export](../export/export-window/export-settings.md) materials and textures using the USD format.
