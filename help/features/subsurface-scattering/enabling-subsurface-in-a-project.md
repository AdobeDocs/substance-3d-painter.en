...
Change the scale and the color to fit the target material. For more details on these settings see: [Subsurface Parameters](subsurface-parameters.md)
...
In the [Environment settings](../../interface/display-settings/environment-settings.md) window, enable the "  **Shadows**  " setting:
