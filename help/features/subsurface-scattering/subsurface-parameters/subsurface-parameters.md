...
| **Scale** | Controls the radius/depth of the light absorption in the material. This parameter behavior change depending of the size of the mesh in the scene.Comparison between a scale of 0.0, 0.2 and 1.0 on a human sized head:   <div><img data-preserve-html="true" src="scale-sss.jpg" width="650"/></div> |
| **Color** | The color of light when absorbed by the material.Comparison between three colors :   <div><img data-preserve-html="true" src="color-sss.jpg" width="650"/></div> |
