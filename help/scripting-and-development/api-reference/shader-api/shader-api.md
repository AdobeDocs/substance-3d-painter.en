...
* [Full changelog file](changelog-shader-api.md)
...
* [lib-alpha.glsl](libraries-shader-api/lib-alpha-shader-api.md) : contains opacity related helpers
* [lib-bayer.glsl](libraries-shader-api/lib-bayer-shader-api.md) : contains bayer matrix helpers
* [lib-defines.glsl](libraries-shader-api/lib-defines-shader-api.md) : contains useful math constants
* [lib-emissive.glsl](libraries-shader-api/lib-emissive-shader-api.md) : contains emissive properties helpers
* [lib-env.glsl](libraries-shader-api/lib-env-shader-api.md) : contains environment map related helpers
* [lib-normal.glsl](libraries-shader-api/lib-normal-shader-api.md) : contains normal map related helpers (and height-map generated normal map)
* [lib-pbr.glsl](libraries-shader-api/lib-pbr-shader-api.md) : contains physically based rendering helpers
* [lib-pbr-aniso.glsl](libraries-shader-api/lib-pbr-aniso-shader-api.md) : contains anisotropic physically based rendering helpers
* [lib-pom.glsl](libraries-shader-api/lib-pom-shader-api.md) : contains parallax occlusion mapping helpers
* [lib-random.glsl](libraries-shader-api/lib-random-shader-api.md) : contains random utilities (low discrepancy sequences)
* [lib-sampler.glsl](libraries-shader-api/lib-sampler-shader-api.md) : contains channel getters helpers
* [lib-sparse.glsl](libraries-shader-api/lib-sparse-shader-api.md) : contains safe sparse texture sampling helpers
* [lib-sss.glsl](libraries-shader-api/lib-sss-shader-api.md) : contains subsurface scattering helpers
* [lib-utils.glsl](libraries-shader-api/lib-utils-shader-api.md) : contains color utility functions (sRGB conversions, tone mapping)
* [lib-vectors.glsl](libraries-shader-api/lib-vectors-shader-api.md) : contains common vectors helpers
...
* [pixelated.glsl](shaders-shader-api/pixelated-shader-api.md) : a pixelating shader
* [toon.glsl](shaders-shader-api/toon-shader-api.md) : a toon shader
* [pbr-metal-rough.glsl](shaders-shader-api/pbr-metal-rough-shader-api.md) : the default PBR shader embedded in Substance Painter
...
* declare editable stacks from a shader definition: [layering\_declare\_stacks.glsl](parameters-shader-api/layering-declare-stacks-shader-api.md)
* bind materials as shader parameters: [layering\_bind\_materials.glsl](parameters-shader-api/layering-bind-materials-shader-api.md)
