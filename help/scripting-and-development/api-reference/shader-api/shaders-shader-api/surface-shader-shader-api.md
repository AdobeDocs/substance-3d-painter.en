...
Note: To obtain a SparseCoord for uv1-uv7, you have to explicitly call *getSparseCoord(vec2)* defined in [lib-sparse.glsl](../libraries-shader-api/lib-sparse-shader-api.md)
