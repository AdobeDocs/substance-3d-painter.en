...
| **--enable-remote-scripting** | Allow to run scripting commands from outside the application. See [Remote control with scripting](../../scripting-and-development/scripts-and-plugins/remote-control-with-scripting.md) for more information. |
