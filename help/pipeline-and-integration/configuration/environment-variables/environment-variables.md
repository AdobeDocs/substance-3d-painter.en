...
| **OCIO** | Path to a **config.ocio** file which will be used to drive the [Color management](../../../help/features/color-management/color-management.md) settings with OpenColorIO.  **Note:**  This environment variable has priority over the **PAINTER\_ACE\_CONFIG** variable. | <ol data-preserve-html="true"><li data-preserve-html="true">4</li></ol> |
| **PAINTER\_ACE\_CONFIG** | Path to a json file which will be used to drive the [Color management](../../../help/features/color-management/color-management.md) settings with Adobe ACE. | <ol data-preserve-html="true"><li data-preserve-html="true">1</li></ol> |
