...
In Painter baking is done via the dedicated Baking Mode. This mode can be accessed via the dedicated icon (little croissant in the contextual toolbar), by using the [mode menu](../interface/main-menu/mode-menu/mode-menu.md), or by using the [keyboard shortcut](../interface/settings/shortcuts/shortcuts.md).
