...
This page lists all the currently active known issues currently present in the latest version of Substance 3D Painter.
...
* `[UV Tiles]` Height combination mask is not refresh with UV Tile mask
