...
> 
> For more information check out our [system requirements page](../getting-started/system-requirements.md).
...
>[!NOTE]
>
> For more information on the <b>Ribbon tool</b>, check out the [dedicated documentation page](../painting/tool-list/ribbon-tool.md).
> 
