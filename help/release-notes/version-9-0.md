...
>[!NOTE]
>
> For more information, see the [dedicated documentation](../painting/tool-list/path.md).
...
>[!NOTE]
>
> For more information, see the [dedicated documentation](../painting/dynamic-strokes/creating-custom-dynamic-strokes.md).
