...
Project files are notorious to have an [heavy file footprint](../../technical-support/workflow-issues/project-issues/projects-are-really-big.md). We took the time to investigate the root cause of this problem and designed a few solutions. This version introduces a first set of changes:
