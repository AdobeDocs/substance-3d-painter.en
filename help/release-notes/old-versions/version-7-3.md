...
For more information on the Warp projection's settings and properties, see the [dedicated documentation page](../../painting/fill-projections/warp-projection.md).
...
For more information, see the [dedicated documentation page](../../painting/fill-projections/cylindrical-projection.md).
...
For more information, see the [dedicated documentation page](../../interface/color-picker.md).
