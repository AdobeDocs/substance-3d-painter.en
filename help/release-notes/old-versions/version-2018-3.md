...
For more information about the SVT take a look at our documentation page : [Sparse Virtual Textures](../../features/sparse-virtual-textures.md)
...
> 
> These settings can be overridden via environment variable : [Environment variables](../../pipeline-and-integration/configuration/environment-variables.md).
...
For more details see the new documentation : [Mesh Based Input](../../content/creating-custom-effects/mesh-based-input.md)
