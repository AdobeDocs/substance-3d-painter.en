...
>[!NOTE]
>
> This release raise the minimum version supported of Ubuntu to 18.04 and MacOS to 10.14. For more details see the [technical requirements](../../getting-started/system-requirements.md).
...
It is recommended to activate the [Lazy mouse](../../painting/lazy-mouse.md) feature in the contextual toolbar to increase the quality of the painted stitches.
