...
description: "Review release notes for Substance 3D Painter version 2021.1 (7.1.0) to learn about new features, improvements, and bug fixes."
...
>[!NOTE]
>
> This release raise the minimum version supported of Ubuntu to 18.04 and MacOS to 10.14. For more details see the [technical requirements](../../../help/getting-started/system-requirements/system-requirements.md).
...
* **New layer stack thumbnails**  
  The optimized layer stack thumbnails have been improved. A material sphere is now displayed for fill layers, making it easier to navigate and see the main properties of each layer even when working with the [UV Tiles](../../../help/features/uv-tiles/uv-tiles.md) workflow. The thumbnail is generated from the layer information but doesn't take into account effects to avoid being recomputed too often.
...
The [Iray renderer](../../../help/features/iray-renderer/iray-renderer.md) has been updated to its latest version and now supports the new Nvidia Ampere GPUs (RTX 3000 Series and Quadro A Series).
...
It is recommended to activate the [Lazy mouse](../../../help/painting/lazy-mouse/lazy-mouse.md) feature in the contextual toolbar to increase the quality of the painted stitches.
