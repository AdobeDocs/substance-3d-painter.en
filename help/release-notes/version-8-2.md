...
A new setting inside [Display Settings](../interface/display-settings/environment-settings.md) allows to align the environment map to the camera making it possible to adjust the lighting angle and light up parts below the 3D model.

To use this new setting, go to [Display Settings](../interface/display-settings/environment-settings.md) and change **Environment alignment** setting:
