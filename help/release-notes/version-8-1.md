...
* **New json template settings** To share and re-use settings across projects it is possible to specify a preset file. To know more about the preset specifications, see the [dedicated documentation](../features/color-management/color-management-with-adobe-ace-icc.md).
...
>[!NOTE]
>
> For more information, see the [dedicated documentation](../features/physical-size.md).
