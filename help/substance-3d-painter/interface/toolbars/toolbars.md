...
Some tools have a second mode named "Physical" which enable particle painting. Particle painting can also be accessed by clicking on Particle brush presets in the [Assets](../assets/assets.md) window.
...
The Contextual Toolbar is a toolbar for which parts of its content change depending on the current tool selected or other property being modified. The left side of the toolbar can change but the right side is fixed and list shortcuts to modify the display of the [Viewport](../viewport/viewport.md).

This toolbar can list properties for the following elements:

* [Painting](../../painting/painting.md)
* [Manipulators for Fill Layer projections](../../painting/fill-projections/fill-projections.md)
