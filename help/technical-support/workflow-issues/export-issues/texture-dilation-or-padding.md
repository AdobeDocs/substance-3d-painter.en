...
Generating a good quality padding is important to ensure good [mipmaps](../../../getting-started/glossary.md) generation later by game engines or offline renderers.   
...
* **When generating textures for a Texture Set** : see the [Texture Set settings](../../../interface/texture-set/texture-set-settings.md) documentation for more information.
