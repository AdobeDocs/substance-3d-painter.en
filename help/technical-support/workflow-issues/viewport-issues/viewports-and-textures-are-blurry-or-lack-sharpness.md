...
The viewports use mipmaps and texture filtering to be able to stream in and out [ Sparse Virtual Textures ](../../../features/sparse-virtual-textures.md) to improve performances. This can lead to blurry textures in some cases.

The texture filtering can be adjusted via the Display Settings window under the [ Viewport Settings](../../../interface/display-settings/viewport-settings.md) parameters.
