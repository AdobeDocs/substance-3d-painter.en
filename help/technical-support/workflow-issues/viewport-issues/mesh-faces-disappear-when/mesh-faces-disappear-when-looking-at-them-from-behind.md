...
To display the back of the faces, simply change the current shader to **pbr-metal-rough-alpha-test** in the [Shader settings](../../../../help/interface/shader-settings/shader-settings.md).
