...
With the introduction of the [Text resource](../../../painting/text-resource.md), fonts file are automatically gathered on startup. Font files can also be manually imported.
