...
UseFile &gt; Save &gt; Save and reduce filesizeto flush unneeded data, and useRemove unused resourcesto get rid of files imported to the project that are not being used anywhere inside the project.
