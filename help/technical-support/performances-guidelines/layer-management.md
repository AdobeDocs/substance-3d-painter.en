...
You can [learn more about geometry masks with this tutorial](https://www.youtube.com/watch?v=TGASuIGSUns), or by [referring to the documentation](../../interface/layer-stack/geometry-mask.md).
