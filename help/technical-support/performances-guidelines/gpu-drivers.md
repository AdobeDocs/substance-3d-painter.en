...
Substance 3D Painter relies a lot on the GPU to perform most of its computations. This is why it is important to have a GPU that follows the [System requirements](../../getting-started/system-requirements.md).
