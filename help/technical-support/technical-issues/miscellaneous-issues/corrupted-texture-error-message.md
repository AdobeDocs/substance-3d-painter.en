...
However if the project spans across multiple texture sets or lots of layers, the [Resource Updater ](../../../features/plugins/resources-updater.md)can be helpful to locate the corrupted resource and replace it temporarily with another one.

>[!NOTE]
>
> * In the cased of the baked textures, don't forget to also clear the Mesh Maps slots in the [Texture Set settings](../../../interface/texture-set/texture-set-settings.md) window.
