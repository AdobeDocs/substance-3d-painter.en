...
Some program can add custom shell extensions which can lead to instabilities or crashes. Take a look at the [Software conflicts](../startup-issues/software-conflicts.md) list for more information.
