...
> You can find the local files for custom templates you have created in the assets/export-presets folder of your [Substance 3D Painter files](../pipeline-and-integration/resource-management/shelf-and-assets-location.md).
