...
The Presets list show all the available Output templates. This list includes a collection of [Default Output templates](../../../export/export-presets/default-presets/default-presets.md), as well as any custom templates that you have created.
...
The second dropdown is sued to specify the bit depth of the output map. The bit depth depends on the file format selected. See [Export settings](../../../export/export-window/export-settings/export-settings.md) for more details.
