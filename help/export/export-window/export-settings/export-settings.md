...
| <b>Output template</b> | Select the output template used to name and composite the channels into texture files. For more information on templates see the [Output templates](../../../export/export-presets/export-presets.md) list. |
