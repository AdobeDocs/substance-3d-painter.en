...
You can override the location that Painter checks for the **license.key** file with an [Environment Variable](../pipeline-and-integration/configuration/environment-variables.md).
