...
| Shortcut list | Link to the [shortcuts](../../../interface/settings/shortcuts/shortcuts.md) documentation. |
...
| Check for updates | Open the [update checker](../../../interface/miscellaneous/update-checker/update-checker.md) window. |
