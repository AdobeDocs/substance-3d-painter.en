...
| Action | Description |
| --- | --- |
| **New** | Open the new project creation window. See: [ Project Creation ](../../getting-started/project-creation.md)for more information. |
...
> * **Full / Compact**  : If a Clean operation is performed or if the project is saved with the action "Save And Compact", the method will rewrite the project on the disk entirely. This method allows to get rid of project fragmentation and reduce the footprint. See: [ Projects are really big](../../technical-support/workflow-issues/project-issues/projects-are-really-big.md).
