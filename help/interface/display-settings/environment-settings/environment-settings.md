...
| *Setting* | *Description* |
| --- | --- |
| **Environment Map** | Environment map texture to be used to light the scene. Can be found in the [Assets](../../../interface/assets/assets.md) window by using the "Environment" preset.Click on the button to open a mini-shelf and choose a different environment map. |
...
| **Environment Rotation** | Controls the horizontal rotation of the environment texture. Useful for rotating the lighting in the scene and change how the object react. Can be controlled with a [ shortcut](../../../interface/settings/shortcuts/shortcuts.md). |
