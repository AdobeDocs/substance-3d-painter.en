...
>[!NOTE]
>
> The location where resource are downloaded depends on the default library. This location can be changed in the preferences, see the dedicated [documentation page](assets/adding-a-new-library.md).
