...
At the top left of the viewport may appear a text indicating the currently loaded profile. For more information see the [Color Profile](../../features/post-processing/color-profile.md) page.
...
Switched between camera can be quickly done by using the dedicated [keyboard shortcut](../settings/shortcuts.md). For more information see the [Camera management](camera-management.md) page.
...
This lighting can be controlled via the [Display settings](../display-settings/display-settings.md) as well as other rendering settings. The lighting orientation can be changed with the help of [keyboard shortcut](../settings/shortcuts.md) as well.
