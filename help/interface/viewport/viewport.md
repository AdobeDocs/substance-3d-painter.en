...
* **2D view**: this view shows UV unwrapping of the 3D mesh for the currently selected [Texture Set](../texture-set/texture-set-list/texture-set-list.md).
...
* [2D view](2d-view/2d-view.md)
* [3D view](3d-view/3d-view.md)
* [Camera management](camera-management/camera-management.md)

The 3D and 2D views can be adjusted to display additional or different information via the [Display settings](../display-settings/display-settings.md).
...
| **Rendering Mode** <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r4-column-c0_dynamic_grid_items_grid-cell_position-par_image" src="viewport-rendering.png"/></div> | Switch to the [rendering mode](../../features/iray-renderer/iray-renderer.md). |
