...
>[!NOTE]
>
> Some of these actions have an associated keyboard shortcut which can be consulted on the [dedicated page](../settings/shortcuts.md).

Drag and dropping resources from the shelf can be a way of creating layers as well :

| *Action* | *Demonstration* |
| --- | --- |
| Drag and Drop a **Material** from the [Assets](../assets/assets.md) into the Layer Stack | <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table1_row-r1-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/dragdrop-material.gif"/></div> |
| Drag and Drop a **Smart Material** from the [Assets](../assets/assets.md) into the Layer Stack | <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table1_row-r2-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/dragdrop-smartmaterial.gif"/></div> |
| Drag and Drop a **Effects** from the [Assets](../assets/assets.md) into the Layer Stack | <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table1_row-r3-column-c1_dynamic_grid_items_grid-cell_position-par_image" src="../../assets/dragdrop-filter.gif"/></div> |
