...
| Add New Smart Materials <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r5-column-c0_dynamic_grid_items_grid-cell_position-par_image" src="icon-smartmat.png"/></div> | Insert a new Smart Material above the currently selected layer.Clicking on this button will open a mini-shelf to browse the list of Smart Materials available in the current [Assets](../../interface/assets/assets.md). |
