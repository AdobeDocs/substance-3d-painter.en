...
* [Creating layers](creating-layers/creating-layers.md)
* [Managing layers](managing-layers/managing-layers.md)
* [Masking and effects](masking-and-effects/masking-and-effects.md)
* [Blending modes](blending-modes/blending-modes.md)
* [Layer instancing](layer-instancing/layer-instancing.md)
* [Geometry mask](geometry-mask/geometry-mask.md)
...
The list in this dropdown is based on the list of channels available in the [Texture Set settings](../texture-set/texture-set-settings/texture-set-settings.md).
...
| Create New Fill Layer <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r4-column-c0_dynamic_grid_items_grid-cell_position-par_image" src="image2020-9-30-12-0-49.png"/></div> | Create a new [Fill layer](../../painting/fill-projections/fill-projections.md) above the currently selected one. |
| Add New Smart Materials <div><img class="" data-preserve-html="true" id="root_content_flex_items_position_position-par_dx_table_row-r5-column-c0_dynamic_grid_items_grid-cell_position-par_image" src="icon-smartmat.png"/></div> | Insert a new Smart Material above the currently selected layer.Clicking on this button will open a mini-shelf to browse the list of Smart Materials available in the current [Assets](../assets/assets.md). |
