...
>[!NOTE]
>
> If the materials changed or have been renamed when loading a new 3D model, the previous Texture Sets in the project can become disabled. This can be fixed with the [Reassignment Window](texture-set/texture-set-reassignment.md) from the **Texture Set List**.
